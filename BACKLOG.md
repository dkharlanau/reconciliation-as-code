...
| Order | Issue | Outcome |
|---:|---|---|
| 11 | [#12 Run-to-run rehearsal diff](https://github.com/dkharlanau/reconciliation-as-code/issues/12) | Show regression/improvement across migration rehearsals. |
| 12 | [#11 Multi-stage reconciliation](https://github.com/dkharlanau/reconciliation-as-code/issues/11) | Identify the stage where a mismatch was first introduced. |
| 13 | [#20 Materiality and business criticality policies](https://github.com/dkharlanau/reconciliation-as-code/issues/20) | Separate critical breaks from low-risk differences while preserving raw evidence. |
| 14 | [#19 JSON/JSONL and Parquet adapters](https://github.com/dkharlanau/reconciliation-as-code/issues/19) | Cover common modern pipeline formats. |
| 15 | [#16 Mapping as Code interoperability](https://github.com/dkharlanau/reconciliation-as-code/issues/16) | Reuse transformation mappings instead of duplicating reconciliation logic. |
| 16 | [#13 PyPI, Docker and reusable GitHub Action](https://github.com/dkharlanau/reconciliation-as-code/issues/13) | Make installation and CI adoption trivial. |
| 17 | [#14 Search-oriented docs site and example gallery](https://github.com/dkharlanau/reconciliation-as-code/issues/14) | Capture real search intent with runnable use cases. |
| 18 | [#15 GitHub discoverability and trust signals](https://github.com/dkharlanau/reconciliation-as-code/issues/15) | Improve GitHub search classification, clarity and contributor confidence. |
