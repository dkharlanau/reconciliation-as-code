    ...
    try:
        ...
        if args.command == "init":
            ...
            spec, todos, source_profile, target_profile = generate_spec(
                args.source, args.target, source_key=args.source_key, target_key=args.target_key,
                interactive=args.interactive, source_sheet=args.source_sheet, target_sheet=args.target_sheet, delimiter=args.delimiter,
            )
            output.parent.mkdir(parents=True, exist_ok=True)
